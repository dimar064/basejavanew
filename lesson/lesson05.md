...
- при поиске uuid не надо использовать методы, который сравнивают объекты model.Resume по equals, в следующих уроках добавим еще поля в model.Resume и в equals и данный вариант не подойдет
